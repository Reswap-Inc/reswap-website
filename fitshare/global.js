// FitShare Interactive Functionality
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (subscribeForm) {
        subscribeForm.addEventListener('submit', function(e) {
            ...
            if (email && validateEmail(email)) {
                ...
                showNotification('Thanks for subscribing to FitShare updates!', 'success');
                this.reset();
            } else {
    ...
    function showNotification(message, type) {
        ...
        Object.assign(notification.style, {
            ...
            gap: '10px',
            minWidth: '300px',
            backgroundColor: type === 'success' ? '#008a73' : '#e74c3c',
...
style.textContent = `
    ...
    .site-header.scrolled {
        ...
        box-shadow: 0 2px 20px rgba(0, 138, 115, 0.1);
    }
    ...
    .feature-card:hover {
        ...
        box-shadow: 0 10px 30px rgba(0, 138, 115, 0.15);
    }
    ...
    .btn:hover {
        ...
        box-shadow: 0 8px 25px rgba(0, 138, 115, 0.25);
    }
